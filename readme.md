...
1. From the root of your local copy execute `$ npm link`
1. CD to your project and execute `$ npm link nysds-asset-manager`
1. Run asset manager commands from npx `$ npx nysds-sync`

Alternately you can add sync functions to your scripts in your project package.json like this:
```json
  "scripts": {
